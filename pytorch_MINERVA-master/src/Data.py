...
class Data_loader():
    ...
    def load_data_all(self, path):
        ...
        entity_path = os.path.join(path, "entity2id.txt") #TODO: modify it entities/entity2id
        relations_path = os.path.join(path, "relation2id.txt") #TODO: modify it relations/relation2id
